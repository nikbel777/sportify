  ...
  <div class="pagePolicy">
    ...
    <div class="pagePolicy__chapter">
      <div style="font-size: 16px" data-customstyle="yes">
        ...
        или определяемому Пользователю веб-сайта https://thismywebsite.com. <br />
        ...
        <br />2.10. Пользователь — любой посетитель веб-сайта https://thismywebsite.com. <br />
    ...
    <div class="pagePolicy__chapter">
      <div style="font-size: 16px" data-customstyle="yes">
        ...
        расположена в сети Интернет по адресу <a href="">https://thismywebsite.com/privacy/.</a>
      </div>
    </div>
  </div>
</template>
