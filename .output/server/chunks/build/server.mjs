...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DY8ctXUW.mjs').then((m) => m.default || m)
  },
  {
    name: "policy",
    path: "/policy",
    component: () => import('./policy-Dsfvk6i0.mjs').then((m) => m.default || m)
  }
];
...
const grabscroll_Yos3dUxXyb = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.directive("grabscroll", {
    mounted(el) {
      el.style.cursor = "grab";
      var saved_page_x;
      var saved_scroll_left;
      var is_event_click = false;
      var handleEventClick = (event) => {
...
const layouts = {
  default: () => import('./default-MnLPOH35.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DsQSHEeu.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRoute as a, useRouter as b, resolveRouteObject as c, navigateTo as d, entry$1 as default, useRuntimeConfig as e, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useNuxtApp as u };
